...
import src.main.se2.polimi.java.util.JsfUtil;
import src.main.se2.polimi.java.util.PaginationHelper;
...
public class BidController implements Serializable {
    ...
    @EJB
    private src.main.se2.polimi.java.BidFacade ejbFacade;
    ...
    public Bid getSelected() {
        if (current == null) {
            current = new Bid();
            current.setBidPK(new src.main.se2.polimi.java.BidPK());
            selectedItemIndex = -1;
        }
        return current;
    }
    ...
    public static class BidControllerConverter implements Converter {
        ...
        src.main.se2.polimi.java.BidPK getKey(String value) {
            src.main.se2.polimi.java.BidPK key;
            String values[] = value.split(SEPARATOR_ESCAPED);
            key = new src.main.se2.polimi.java.BidPK();
            key.setUsername(values[0]);
            key.setAuctionid(Integer.parseInt(values[1]));
            return key;
        }

        String getStringKey(src.main.se2.polimi.java.BidPK value) {
